<?php
	...
	if(!$dbc){ // there was an error connecting
		...
		//deleting row from Group Requests table where the request_uid field matches our inputted request_uid
		$query = mysqli_query($dbc,"DELETE FROM `Group Requests` WHERE request_uid = '$request_uid'");
